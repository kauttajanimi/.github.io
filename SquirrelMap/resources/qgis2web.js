...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 12, minZoom: 8, projection: new ol.proj.Projection({
            code: 'EPSG:3067',
...
map.getView().fit([247438.389029, 6578478.014701, 504217.269950, 6750933.860542], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Flying squirrel observations in Uusimaa region from 1980 to 2025</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (107 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Includes:<br />Metsähallitus flying squirrel data<br />MML 2019 Maastokartta features<br />MML 2025 Hallintorajat features';
            }
